  ...
  return (
    <main
      ...
      <form onSubmit={handleSubmit} className="w-25 mt-5">
        ...
        <Button variant="contained" type="submit" className="btn btn-primary w-100">Log In</Button>
          ...
          <div className="modal-content">
            <div className="modal-body">
              <form onSubmit={handleSubmit}>
                ...
                <Button variant="contained" type="submit" className="btn mb-3 btn-primary w-100">Sign up</Button>
              </form>
            </div>
          </div>
        </div>
